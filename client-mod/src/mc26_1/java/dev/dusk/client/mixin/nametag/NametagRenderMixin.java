 ...
 * drawn in place of vanilla's box. 26.1 flavour.
 */
@Mixin(NameTagFeatureRenderer.class)
public abstract class NametagRenderMixin {
    @WrapOperation(method = "renderTranslucent", at = @At(value = "INVOKE",
    ...
    private void duskclient$drawNametag(Font font, Component text, float x, float y, int color, boolean shadow, Matrix4fc pose,
