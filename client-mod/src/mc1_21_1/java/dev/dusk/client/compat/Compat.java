...
/** The version-specific calls the shared code needs. 1.21–1.21.1 flavour. */
public final class Compat {
    ...
    /** Item cooldowns are keyed by item up to 1.21.1 (by stack from 1.21.2). */
    ...
    public static int signDarkColor(SignText text) {
        return SignRenderer.getDarkColor(text);
    }
