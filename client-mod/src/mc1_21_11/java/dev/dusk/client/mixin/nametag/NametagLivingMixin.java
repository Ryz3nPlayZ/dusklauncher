...
public abstract class NametagLivingMixin {
    ...
    @WrapOperation(method = "shouldShowName(Lnet/minecraft/world/entity/LivingEntity;D)Z",
            at = @At(value = "INVOKE", target = "Lnet/minecraft/client/Minecraft;renderNames()Z"))
    private boolean duskclient$hiddenHud(Operation<Boolean> original, @Local(argsOnly = true) LivingEntity entity) {
        return NametagHooks.renderNamesUnderF1(entity, original.call());
    }
}
