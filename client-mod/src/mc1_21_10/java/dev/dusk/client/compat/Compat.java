...
/** The version-specific calls the shared code needs. 1.21.9–1.21.10 flavour. */
public final class Compat {
    ...
    public static KeyMapping registerKey(String name, int glfwKey) {
        if (keyCategory == null) {
            keyCategory = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath("duskclient", "client"));
        }
