...
/**
 * Wires the shared HUD into Fabric's HUD element list. 26.2 flavour:
 * elements extract render state through GuiGraphicsExtractor. The
 * crosshair is not replaced here: CrosshairGuiMixin swaps just the
 * vanilla sprite so the attack indicator keeps rendering.
 */
public final class HudHooks {
    private HudHooks() {}

    public static void register() {
        HudElementRegistry.addLast(Identifier.fromNamespaceAndPath("duskclient", "hud"), (graphics, tick) -> {
